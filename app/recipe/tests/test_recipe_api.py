...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_update_user_return_error(self):
        """Test changing user the recipe user results in an error."""
    ...
    def test_recipe_other_recipe_error(self):
        ...
        new_user = create_user(email='user2@example.com', password='test1223')
    ...
    def test_create_recipe_with_new_tag(self):
        """Test creting a recipe with new tag"""
        payload = {
            'title': 'Dolma',
            'time_minutes': 30,
            'price': Decimal('2.50'),
    ...
    def test_create_recipe_with_existing_tag(self):
        """Test creating a recipse with existing tag."""
        tag_indian = Tag.objects.create(user=self.user, name='Indian')
        payload = {
            'title': 'Pongal',
            'time_minutes': 60,
            'price': Decimal('4.50'),
            'tags': [{'name': 'Indian'}, {'name': 'Breakfeast'}]
        }
        response = self.client.post(RECIPE_URL, payload, format='json')
    ...
    def test_update_urecipe_assign_tag(self):
        """Test assigining an exisiting tag when updating a recipe."""
    ...
    def test_filter_by_tags(self):
        """Filterin recipes by tags."""
        r1 = create_recipe(user=self.user, title='Thai Vagatable Curry')
        r2 = create_recipe(user=self.user, title='Eggplant with Tahimi')
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicken Roast')
